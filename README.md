...
The preserved reviewer guide's statement that the package had not yet been publicly deposited describes its pre-publication snapshot. This repository is the subsequent public deposit; the journal submission is a separate process.
